...
Projeto desenvolvido durante o curso `Trabalhando com Funções` durante o 'Potência Tech iFood - Programação do Zero' da DIO (Digital Innovation One).

<p align="center">
  <img src=".github/Calculadora-de-Partidas-Rankeadas.jpg" width="100%">
</p>
